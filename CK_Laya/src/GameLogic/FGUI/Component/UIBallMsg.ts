...
export class UIBallMsg {
    ...
    {
        // console.log("[UIBallMsg]ChangeBlood",blood);
        // if (this.uiBall==null) {
        //     this.uiBall=new UIBall(this.ballLoader.displayObject,blood,2.05);
        //     this.uiBall.Show();
        //     this.uiBall.StartRotate();
        // }
        // else{
        //     // this.uiBall.StopRotate();
        //     this.uiBall.Change(this.ballLoader.displayObject,blood,2.05);
        // }
